...
// newArr.forEach((element) => element[1] *= 2);
// console.log(newArr);
...
// --> loop on an array and retrieve data from this array or modify the array

// colors.forEach(element => console.log(element))
// const result = colors.map(element => return console.log(element))

//colors.forEach((element,index) => colors[index] = element + "hello" )
